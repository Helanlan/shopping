...
public class SpuController {
    ...
    public Result<Goods> findGoodsBySpuId(@PathVariable(value = "id") Long spuId){
        Goods goods = spuService.findGoodsBySpuId(spuId);
        return new Result<Goods>(true,StatusCode.OK,"商品信息在此",goods);
    }
    ...
    public Result<Goods> updateGoods(@RequestBody Goods goods){
        spuService.updateGoode(goods);
        return new Result<>(true, StatusCode.OK,"商品信息修成功");
    }
     ...
     * @param spuId
     */
    @PutMapping(value = "/examineGooods/{id}")
    public Result examineGoods(@PathVariable(value = "id") Long spuId){
        spuService.examineGoods(spuId);
     ...
     * @param spuId
     */
    @PutMapping(value = "/pullGooods/{id}")
    public Result pullGoods(@PathVariable(value = "id") Long spuId){
        spuService.pullGoods(spuId);
     ...
     * @param spuId
     */
    @PutMapping(value = "/putGooods/{id}")
    public Result putGoods(@PathVariable(value = "id") Long spuId){
        spuService.putGoods(spuId);
     ...
     * @param ids
     */
    @PutMapping(value = "/putGoods/many")
    public Result putManyGoods(@RequestBody  Long[] ids){
        spuService.putManyGoods(ids);
     ...
     * 找回商品
     */
    @PutMapping(value = "/refindGoods/{id}")
    public Result refindGoods(@PathVariable(value = "id") Long spuId){
        spuService.refindGoods(spuId);
